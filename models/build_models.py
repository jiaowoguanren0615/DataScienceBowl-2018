...
class EffiSegNetBN(nn.Module):
    def __init__(
        ...
        # print(f'upsampled_size: {upsampled_size}')  # 224
        upsampled_size = img_size
        ...
        self.conv6 = nn.Conv2d(ch, nb_classes, kernel_size=1, stride=1, padding=0, bias=False)
