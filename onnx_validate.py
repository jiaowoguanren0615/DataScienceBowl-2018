...
parser.add_argument('--data_root', default='/mnt/d/DataScienceBowl2018', type=str,
                    help='path to datasets')
parser.add_argument('--onnx-input', default='./efficientnet-b0_optim.onnx', type=str, metavar='PATH',
